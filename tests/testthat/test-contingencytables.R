...
test_that("Main table results match", {
  ...
  jaspTools::expect_equal_tables(table,
    list(0.489296636085627, 320, 394.529977794227, -3.75224327419637, 0.236861584011843,
         ...
         815, 815, 0.603256846780163, 1, " % within column", "Count",
         "Expected count", "Pearson residuals", " % of total", " % within row",
         "Standardized residuals", "Unstandardized residuals", 0.510703363914373,
         334, 259.470022205773, 4.62687106461469, 0.247224278312361,
         0.623134328358209, 8.29368531337046, 74.5299777942265, 0.289813486370158,
         202, 276.529977794227, -4.48187647166511, 0.149518874907476,
         0.376865671641791, -8.29368531337046, -74.5299777942265, "experimental",
         ...
         1351, 1, 1, " % within column", "Count", "Expected count", " % of total",
         " % within row", 0.338688085676037, 253, 271.013344453711, -1.09420580859867,
         0.211009174311927, 0.581609195402299, -2.23255569694362, -18.0133444537115,
         0.402654867256637, 182, 163.986655546289, 1.40666311404823,
         0.151793160967473, 0.418390804597701, 2.23255569694361, 18.0133444537114,
         "control", "m", 0.362802335279399, 435, 435, 0.3628023352794,
         1, " % within column", "Count", "Expected count", "Pearson residuals",
         ...
         " % within row", 0.408993576017131, 573, 686.764705882353, -4.34113772648338,
         0.224705882352941, 0.4584, -9.05757740964558, -113.764705882353,
         0.589208006962576, 677, 563.235294117647, 4.79360911772348,
         0.265490196078431, 0.5416, 9.05757740964558, 113.764705882353,
         "control", "Total", 0.490196078431373, 1250, 1250, 0.490196078431373,
         1, " % within column", "Count", "Expected count", "Pearson residuals",
         " % of total", " % within row", "Standardized residuals", "Unstandardized residuals",
         ...
         "experimental", "Total", 0.509803921568627, 1300, 1300, 0.509803921568627,
         1, " % within column", "Count", "Expected count", "Pearson residuals",
         " % of total", " % within row", "Standardized residuals", "Unstandardized residuals",

...
test_that("Main table results match", {
  ...
  options$resids             <- TRUE
  options$standardizedResids <- TRUE
  options$adjustedResids     <- TRUE
  ...
  jaspTools::expect_equal_tables(table,
      list(-8.29368531337046, 0.489296636085627, 320, 394.529977794227, 0.236861584011843,
           -74.5299777942265, 0.392638036809816, -3.75224327419637, 8.29368531337046,
           0.710186513629842, 495, 420.470022205773, 0.36639526276832,
           74.5299777942265, 0.607361963190184, 3.63465733359156, "control",
           "f", " ", 0.603256846780163, 815, 815, 0.603256846780163, " ",
           1, " ", "Adj. Standardized residuals", " % within column", "Count",
           "Expected count", " % of total", "Unstandardized Residuals",
           " % within row", "Standardized residuals", 8.29368531337046,
           0.510703363914373, 334, 259.470022205773, 0.247224278312361,
           74.5299777942265, 0.623134328358209, 4.62687106461469, -8.29368531337046,
           0.289813486370158, 202, 276.529977794227, 0.149518874907476,
           -74.5299777942265, 0.376865671641791, -4.48187647166511, "experimental",
           "f", " ", 0.396743153219837, 536, 536, 0.396743153219837, " ",
           1, " ", "Adj. Standardized residuals", " % within column", "Count",
           "Expected count", " % of total", "Unstandardized Residuals",
           " % within row", "Standardized residuals", 1, 654, 654, 0.484085862324204,
           0.484085862324204, 1, 697, 697, 0.515914137675796, 0.515914137675796,
           "Total", "f", 1, 1351, 1351, 1, 1, " % within column", "Count",
           "Expected count", " % of total", " % within row", -2.23255569694362,
           0.338688085676037, 253, 271.013344453711, 0.211009174311927,
           -18.0133444537115, 0.581609195402299, -1.09420580859867, 2.23255569694361,
           0.402654867256637, 182, 163.986655546289, 0.151793160967473,
           18.0133444537114, 0.418390804597701, 1.40666311404823, "control",
           "m", " ", 0.362802335279399, 435, 435, 0.3628023352794, " ",
           1, " ", "Adj. Standardized residuals", " % within column", "Count",
           "Expected count", " % of total", "Unstandardized Residuals",
           " % within row", "Standardized residuals", 2.23255569694362,
           0.661311914323963, 494, 475.986655546289, 0.412010008340284,
           18.0133444537115, 0.646596858638743, 0.82565186283563, -2.23255569694362,
           0.597345132743363, 270, 288.013344453711, 0.225187656380317,
           -18.0133444537115, 0.353403141361257, -1.06142191109686, "experimental",
           "m", " ", 0.6371976647206, 764, 764, 0.6371976647206, " ", 1,
           " ", "Adj. Standardized residuals", " % within column", "Count",
           "Expected count", " % of total", "Unstandardized Residuals",
           " % within row", "Standardized residuals", 1, 747, 747, 0.62301918265221,
           0.62301918265221, 1, 452, 452, 0.37698081734779, 0.37698081734779,
           "Total", "m", 1, 1199, 1199, 1, 1, " % within column", "Count",
           "Expected count", " % of total", " % within row", -9.05757740964558,
           0.408993576017131, 573, 686.764705882353, 0.224705882352941,
           -113.764705882353, 0.4584, -4.34113772648338, 9.05757740964558,
           0.589208006962576, 677, 563.235294117647, 0.265490196078431,
           113.764705882353, 0.5416, 4.79360911772348, "control", "Total",
           " ", 0.490196078431373, 1250, 1250, 0.490196078431373, " ",
           1, " ", "Adj. Standardized residuals", " % within column", "Count",
           "Expected count", " % of total", "Unstandardized Residuals",
           " % within row", "Standardized residuals", 9.05757740964558,
           0.591006423982869, 828, 714.235294117647, 0.324705882352941,
           113.764705882353, 0.636923076923077, 4.25683576510241, -9.05757740964558,
           0.410791993037424, 472, 585.764705882353, 0.185098039215686,
           -113.764705882353, 0.363076923076923, -4.70052046765545, "experimental",
           "Total", " ", 0.509803921568627, 1300, 1300, 0.509803921568627,
           " ", 1, " ", "Adj. Standardized residuals", " % within column",
           "Count", "Expected count", " % of total", "Unstandardized Residuals",
           " % within row", "Standardized residuals", 1, 1401, 1401, 0.549411764705882,
           0.549411764705882, 1, 1149, 1149, 0.450588235294118, 0.450588235294118,
           "Total", "Total", 1, 2550, 2550, 1, 1, " % within column", "Count",
           "Expected count", " % of total", " % within row")
  )
})

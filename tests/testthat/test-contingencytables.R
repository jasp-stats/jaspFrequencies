...
test_that("Main table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.489296636085627, 320, 394.529977794227, -3.75224327419637, 0.236861584011843,
                                      0.392638036809816, -8.29368531337046, -74.5299777942265, 0.710186513629842,
                                      495, 420.470022205773, 3.63465733359156, 0.36639526276832, 0.607361963190184,
                                      8.29368531337046, 74.5299777942265, "control", "f", 0.603256846780163,
                                      815, 815, " ", 0.603256846780163, 1, " ", " ", " % within column",
                                      "Count", "Expected count", "Pearson residuals", " % of total",
                                      " % within row", "Standardized residuals", "Unstandardized residuals",
                                      0.510703363914373, 334, 259.470022205773, 4.62687106461469,
                                      0.247224278312361, 0.623134328358209, 8.29368531337046, 74.5299777942265,
                                      0.289813486370158, 202, 276.529977794227, -4.48187647166511,
                                      0.149518874907476, 0.376865671641791, -8.29368531337046, -74.5299777942265,
                                      "experimental", "f", 0.396743153219837, 536, 536, " ", 0.396743153219837,
                                      1, " ", " ", " % within column", "Count", "Expected count",
                                      "Pearson residuals", " % of total", " % within row", "Standardized residuals",
                                      "Unstandardized residuals", 1, 654, 654, 0.484085862324204,
                                      0.484085862324204, 1, 697, 697, 0.515914137675796, 0.515914137675796,
                                      "Total", "f", 1, 1351, 1351, 1, 1, " % within column", "Count",
                                      "Expected count", " % of total", " % within row", 0.338688085676037,
                                      253, 271.013344453711, -1.09420580859867, 0.211009174311927,
                                      0.581609195402299, -2.23255569694362, -18.0133444537115, 0.402654867256637,
                                      182, 163.986655546289, 1.40666311404823, 0.151793160967473,
                                      0.418390804597701, 2.23255569694361, 18.0133444537114, "control",
                                      "m", 0.362802335279399, 435, 435, " ", 0.3628023352794, 1, " ",
                                      " ", " % within column", "Count", "Expected count", "Pearson residuals",
                                      " % of total", " % within row", "Standardized residuals", "Unstandardized residuals",
                                      0.661311914323963, 494, 475.986655546289, 0.82565186283563,
                                      0.412010008340284, 0.646596858638743, 2.23255569694362, 18.0133444537115,
                                      0.597345132743363, 270, 288.013344453711, -1.06142191109686,
                                      0.225187656380317, 0.353403141361257, -2.23255569694362, -18.0133444537115,
                                      "experimental", "m", 0.6371976647206, 764, 764, " ", 0.6371976647206,
                                      1, " ", " ", " % within column", "Count", "Expected count",
                                      "Pearson residuals", " % of total", " % within row", "Standardized residuals",
                                      "Unstandardized residuals", 1, 747, 747, 0.62301918265221, 0.62301918265221,
                                      1, 452, 452, 0.37698081734779, 0.37698081734779, "Total", "m",
                                      1, 1199, 1199, 1, 1, " % within column", "Count", "Expected count",
                                      " % of total", " % within row", 0.408993576017131, 573, 686.764705882353,
                                      -4.34113772648338, 0.224705882352941, 0.4584, -9.05757740964558,
                                      -113.764705882353, 0.589208006962576, 677, 563.235294117647,
                                      4.79360911772348, 0.265490196078431, 0.5416, 9.05757740964558,
                                      113.764705882353, "control", "Total", 0.490196078431373, 1250,
                                      1250, " ", 0.490196078431373, 1, " ", " ", " % within column",
                                      "Count", "Expected count", "Pearson residuals", " % of total",
                                      " % within row", "Standardized residuals", "Unstandardized residuals",
                                      0.591006423982869, 828, 714.235294117647, 4.25683576510241,
                                      0.324705882352941, 0.636923076923077, 9.05757740964558, 113.764705882353,
                                      0.410791993037424, 472, 585.764705882353, -4.70052046765545,
                                      0.185098039215686, 0.363076923076923, -9.05757740964558, -113.764705882353,
                                      "experimental", "Total", 0.509803921568627, 1300, 1300, " ",
                                      0.509803921568627, 1, " ", " ", " % within column", "Count",
                                      "Expected count", "Pearson residuals", " % of total", " % within row",
                                      "Standardized residuals", "Unstandardized residuals", 1, 1401,
                                      1401, 0.549411764705882, 0.549411764705882, 1, 1149, 1149, 0.450588235294118,
